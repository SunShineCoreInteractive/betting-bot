...
MIN_MODEL_PROBABILITY = 0.80   # ανέβηκε από 55% -- το Statistics Bet έδειξε χαμηλό πραγματικό ποσοστό επιτυχίας (39%), οπότε είμαστε πιο επιλεκτικοί
...
COMBO_BETS_MIN_LEG_PROB = 0.80   # ευθυγραμμισμένο με το νέο γενικό όριο (πριν ήταν 55%)
