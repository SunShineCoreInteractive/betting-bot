...
def load():
    """Δημόσια συνάρτηση -- καλείται ρητά από το main.py στο startup(), ΑΦΟΥ
    έχει ρυθμιστεί το logging (όχι αυτόματα στο import, αλλιώς τα πρώτα logs
    "χάνονται" επειδή το logging δεν έχει ενεργοποιηθεί ακόμα)."""
    _load()
